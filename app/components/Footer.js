        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:info@sunlandnews.com" className="text-gray-600 hover:text-primary">info@sunlandnews.com</a></li>
              <li><a href="https://events.sunland.news" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary">Events</a></li>
            </ul>
          </div>
