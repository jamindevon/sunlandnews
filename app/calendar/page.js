                ...
                <div className="container mx-auto max-w-3xl px-4">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h3 className="font-bold text-lg mb-2">Does this work with my phone?</h3>
                            <p className="text-gray-600">Yes! It works natively with Apple Calendar (iPhone), Google Calendar (Android/Desktop), and Outlook.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h3 className="font-bold text-lg mb-2">Can I change my preferences later?</h3>
                            <p className="text-gray-600">Absolutely. You can update your interests and availability anytime, and your calendar will automatically update to match.</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h3 className="font-bold text-lg mb-2">Is this a monthly subscription?</h3>
                            <p className="text-gray-600">No. It's a simple one-time payment of $39 for a full year of access.</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 text-center">
                        <button
                            onClick={handlePurchase}
                            disabled={loading}
                            className="inline-flex items-center justify-center px-8 py-4 bg-primary text-white font-bold text-lg rounded-full hover:bg-primary/90 transition-all shadow-lg shadow-primary/30"
                        >
                            Get Started Now
                        </button>
                    </div>
